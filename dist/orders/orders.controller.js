...
let OrdersController = class OrdersController {
    ...
    async findAll(status, priority, zone, startDate, endDate, page, limit) {
    ...
    async findRiderOrders(req) {
        const authReq = req;
        return this.ordersService.findRiderOrders(authReq.user.userId);
    }
    async updateStatus(id, req, status, proofPhoto, failureReason) {
        const authReq = req;
        return this.ordersService.updateStatus(id, authReq.user.userId, status, proofPhoto, failureReason);
    }
};
...
__decorate([
    (0, common_1.Get)('rider/my'),
    (0, roles_decorator_1.Roles)('rider'),
    __param(0, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], OrdersController.prototype, "findRiderOrders", null);
__decorate([
    ...
    __param(3, (0, common_1.Body)('proofPhoto')),
    __param(4, (0, common_1.Body)('failureReason')),
    __metadata("design:type", Function),
